			<section class="uk-section">
				<div class="uk-container uk-container-small">
					...
					?>
					<form action="/berita/new" name="beritabaru" class="uk-form uk-form-stacked" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
						<div class="uk-margin">
							<label class="uk-form-label">Judul</label>
							<div class="uk-form-controls">
								<input class="uk-form-input uk-width-1-1 uk-form-large" type="text" name="judul" <?php if (isset ($post['judul'])) { echo 'value="'. $post['judul'] .'"'; } ?> required/>
							</div>
						</div>
						<div class="uk-margin">
						...
						<div class="uk-margin">
							...
							<div class="uk-form-controls">
								<textarea class="uk-textarea" rows="5" name="intro" placeholder="Tuliskan paragraf pertama berita di sini" required><?php if (isset ($post['intro'])) { echo $post['intro']; } ?></textarea>
							</div>
						</div>
						<div class="uk-margin">
							<label class="uk-form-label">Konten Berita</label>
							<div class="uk-form-controls">
								<textarea id="beritainput" name="content"><?php if (isset ($post['content'])) { echo $post['content']; } ?></textarea>
								<script>
									tinymce.init({
